...
import { dbColunm, DEFAULT_COL, getDataFromQuery, getUser, sqlHelper, toCamelCase } from '../common';
import moment from 'moment';
import { db } from '../db';


class GenderController {
  tablesName = 'master_gender'
  col: dbColunm[] = [
    {
      id: 'Title',
    },
...
export const gender = new GenderController();
